...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-lg-4 offset-lg-4 mt-2 border">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <asp:RadioButton ID="rdoReviewer" GroupName="UserType" runat="server" Text="Reviewer" /><br />
                    <asp:RadioButton ID="rdoRepresentative" GroupName="UserType" runat="server" Text="Representative" /><br />
            ...
            <div class="row form-group justify-content-center">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Register" CssClass="btn-primary" OnClick="btnRegister_Click" />
            </div>            
        </div>
    </form>
</body>
